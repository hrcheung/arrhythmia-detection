...
\inputminted[breaklines]{Matlab}{./code-snippet/HelloWorld.m}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.441\textwidth}
        \includegraphics[width=\textwidth]{latex-images/Sub-figures_Example/cavity_100_streamlines_ghia.png}
    ...
    \\  % This makes a new line
    \begin{subfigure}[t]{0.450\textwidth}
        \includegraphics[width=\textwidth]{latex-images/Sub-figures_Example/cavity_1000_streamlines.png}
        \caption*{$Re = 1000$ - Exercise}
    \end{subfigure}
    \begin{subfigure}[t]{0.438\textwidth}
        \includegraphics[width=\textwidth]{latex-images/Sub-figures_Example/cavity_1000_streamlines_ghia.png}
